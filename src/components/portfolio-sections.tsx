...
export function PortfolioAboutSection({
  ...
  return (
    <section className="mx-auto mt-16 w-full max-w-6xl px-4 sm:mt-24 sm:px-8">
      ...
      <div className="mt-10 space-y-8">
        {content.about.narratives.map((item) => (
          <article
            key={item.title}
            className="rounded-[16px] border border-white/10 bg-[#040404] p-6 sm:p-8"
          >
...
export function PortfolioCategorySection({
  ...
  return (
    <section className="mx-auto mt-14 w-full max-w-6xl px-4 sm:mt-20 sm:px-8">
